...
const ITEMS = [
  ...
  { tag: 'Plugin', label: 'Design System Generator',          hint: 'tokens → starter screens · in Figma',    href: '#' },
  { tag: 'Plugin', label: 'Design System Validator',          hint: 'flag breaks before handoff',             href: '#' },
  { tag: 'Plugin', label: 'Conversation Flow Generator',      hint: 'flows · powered by Anthropic',           href: '#' },
